  ...
  return (
    <>
      <div className='flex flex-wrap justify-center'>
        <div className='rounded-md bg-slate-100 m-4 p-6 w-80 h-full'>
        ...
        <div className="rounded-md bg-slate-100 m-4 p-6 w-80 h-full">
          ...
          <div className='h-1/2'>
            <div className='flex flex-col space-y-2'>
              <div className="bg-slate-200 p-2 rounded-md text-xs">Years of experience</div>
              <div className="bg-slate-200 p-2 rounded-md text-xs">Project challenge</div>
            </div>
            <div className='flex flex-col space-y-2 mt-4'>
              <div className="bg-slate-200 p-2 rounded-md text-xs">Positive reviews</div>
              <div className="bg-slate-200 p-2 rounded-md text-xs">Trusted students</div>
            </div>
          </div>
        </div>
      </div>
      <div>
        <div className='flex flex-wrap  justify-center mb-4'>
          <div className='rounded-md bg-slate-100 w-1/2 md:w-2/3 h-full' >
          ...
          <div>
          <img src="https://images.pexels.com/photos/371589/pexels-photo-371589.jpeg?cs=srgb&dl=clouds-conifer-daylight-371589.jpg&fm=jpg" className='w-full h-32 rounded-md object-cover ml-2 items-center' alt="Project" />
          </div>
        </div>
        <div className='flex md:flex-wrap flex-wrap-reverse justify-center mt-4 mb-4'>
          ...
          <div className='rounded-md bg-slate-100 w-1/2 md:w-2/3 h-full ml-2' >
